...
export const Nav = () => {
  return (
    <nav className="flex justify-between items-center px-8 py-4 z-30 sticky top-0 border-b border-white/20 shadow-sm bg-white dark:bg-black transition-colors">
      <div>
